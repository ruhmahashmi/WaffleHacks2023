...
function openModal(index) {
  ...
  const adviceContent = [
    ...
    <div class="advice-image">
      <img src="meal-planning-image.jpg" alt="Smart Meal Planning">
    </div>
    <div class="advice-content">
      ...
      <ul>
        <li><strong>Plan your meals:</strong> <br>Take some time each week to plan your meals. This will help you create a shopping list and avoid buying unnecessary items. <p> Check out <a href="https://www.examplemealplanningwebsite.com">Example Meal Planning Website</a> for meal planning templates and ideas.</p></li>
        <br>
        <li><strong>Buy in bulk:</strong> <br>Purchase staple ingredients in larger quantities to save money in the long run. Items like rice, pasta, beans, and canned goods can be stored and used over time.<p> Visit <a href="https://www.examplebulkbuyingwebsite.com">Example Bulk Buying Website</a> for bulk purchasing options and discounts.</p></li>
        <br>
        <li><strong>Utilize leftovers:</strong> <br> Get creative with leftovers by repurposing them into new dishes. For example, leftover roasted chicken can be used in sandwiches or salads, and extra cooked vegetables can be turned into flavorful stir-fries or omelettes. <p> Check out <a href="https://www.exampleleftoverrecipeswebsite.com">Example Leftover Recipes Website</a> for inspiration.</p> </li>
      </ul>
...
<div class="advice-section">
  <h2>Budget-Friendly Meals: Delicious and Affordable Recipes</h2>
...
<section id="cooking-tips">
  ...
  <div class="tip-card">
    <img src="images/budget-friendly.jpg" alt="Budget-Friendly Ingredients">
  ...
  <div class="tip-card">
    <img src="images/bulk-cooking.jpg" alt="Bulk Cooking">
    <h3>DIY snacks</h3>
  ...
  <div class="tip-card">
    <img src="images/repurpose-leftovers.jpg" alt="Repurpose Leftovers">
